...
async function seedDatabase() {
  ...
  if (existingQuestions.length === 0) {
    const questionsData = [
      ...
      {
        question: "What is the resolution setting of NTBs at the branch?",
        options: ["1920x1080", "1366x768", "1600x900", "1280x720"],
      ...
      {
        question: "What shortcut checks the resolution of NTB?",
        options: ["CTRL+ALT+DELETE", "CTRL+ALT+M", "ALT+F4", "SHIFT+TAB"],
      ...
      {
        question: "A client staked 1,000 on an event having 9.50 odds, what is the expected win?",
        options: ["95,000", "9,500", "950", "10,500"],
        correctAnswer: "9,500",
        level: "Boss"
      },
      {
        question: "State the types of bet on prematch.",
        options: ["Single and Double", "Ako and Combi", "Online and Offline", "Home and Away"],
        correctAnswer: "Ako and Combi",
        level: "Legend"
      },
      {
